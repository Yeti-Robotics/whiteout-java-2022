...
public class DriveForwardThenBumpFireCommandGroup extends SequentialCommandGroup {
  public DriveForwardThenBumpFireCommandGroup(double drivePower, DrivetrainSubsystem drivetrainSubsystem, ShooterSubsystem shooterSubsystem, IntakeSubsystem intakeSubsystem, HopperSubsystem hopperSubsystem, NeckSubsystem neckSubsystem) {
    addCommands(
